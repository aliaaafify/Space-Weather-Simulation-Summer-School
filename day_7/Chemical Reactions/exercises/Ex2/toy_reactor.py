...
S = np.array([[-1,0,0],[1,-1,1],[0,2,-2]]) #stoichiometry matrix for the reaction ex.2
k = np.array([100.0,0.25,1.0])  # the reaction rate coefficients
c_0 = np.array([1.0,0,0]) # intial composition of the reaction
